...
function groups.get(contrast)
  ...
  return {
    ...
    NavicIconsNamespace = { link = "CmpItemKindUnit" },
    ...
    NavicIconsArray = { link = "CmpItemKindUnit" },
    NavicIconsObject = { link = "CmpItemKindStruct" },
    NavicIconsKey = { link = "CmpItemKindEnumMember" },
